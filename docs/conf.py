...
# The language for content autogenerated by Sphinx. Refer to documentation for a list
# of supported languages. This is also used if you do content translation via gettext
# catalogs. Usually you set "language" from the command line for these cases.
# language = None

# There are two options for replacing |today|: either, you set today to some non-false
...
# ignore when looking for source files. These patterns also affect html_static_path
# and html_extra_path
...
# If true, sectionauthor and moduleauthor directives will be shown in the output. They
...
# Grouping the document tree into LaTeX files. List of tuples (source start file,
# target name, title,  author, documentclass [howto, manual, or own class]).
latex_documents = [
    (
        "index",
        "ECpy.tex",
...
# Grouping the document tree into Texinfo files. List of tuples (source start file,
# target name, title, author, dir menu entry, description, category)
texinfo_documents = [
    (
        "index",
        "ECpy",
