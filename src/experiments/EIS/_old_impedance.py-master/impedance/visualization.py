...
def plot_residuals(ax, f, res_real, res_imag, fmt=".-", y_limits=(-5, 5), **kwargs):
    ...
    **kwargs : `matplotlib.pyplot.Line2D` properties, optional
    ...
    ax.plot(f, res_real * 100, fmt, label=r"$\Delta_{\,\mathrm{Re}}$", **kwargs)
    ax.plot(f, res_imag * 100, fmt, label=r"$\Delta_{\,\mathrm{Im}}$", **kwargs)
